...
export const HEADER_CONTENT_CLASSES = 'flex items-center justify-end';

export const HEADER_LOGO_CLASSES =
  'flex items-center text-xl font-bold text-white hover:text-gray-900 dark:text-white dark:hover:text-white transition-colors duration-150';

export const HEADER_DESKTOP_NAV_CLASSES = 'hidden lg:flex items-center space-x-4';
