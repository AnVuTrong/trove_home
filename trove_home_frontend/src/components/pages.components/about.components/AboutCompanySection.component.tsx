...
export class AboutCompanySectionClass {
  ...
  private static readonly PLACEHOLDER_CONTAINER_CLASSES = 'bg-gray-50 dark:bg-background-surface_dark p-8 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600';
