...
const StarIcon: React.FC = () => (
  <svg className={PricingTestimonialsSectionClass.getStarIconClasses()} fill="currentColor" viewBox="0 0 20 20">
...
const PricingTestimonialsSection: React.FC<PricingTestimonialsSectionProps> = ({ 
  ...
  return (
    <section className={`${PricingTestimonialsSectionClass.getSectionContainerClasses()} ${className}`}>
      <div className={PricingTestimonialsSectionClass.getContentContainerClasses()}>
        <div className={PricingTestimonialsSectionClass.getHeaderContainerClasses()}>
          <h2 className={PricingTestimonialsSectionClass.getTitleClasses()}>
            {t(titleKey)}
          </h2>
