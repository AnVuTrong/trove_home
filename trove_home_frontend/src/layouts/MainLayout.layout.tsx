...
const MainLayout: React.FC = () => {
  return (
    <LanguageProvider>
      <div className="flex flex-col min-h-screen bg-background-light dark:bg-background-dark text-text-DEFAULT dark:text-text-dark transition-colors duration-300">
        <Header />
