      ...
      <section className="relative min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row w-full">
          ...
          <div className="flex-1 lg:w-1/2 flex items-center justify-center p-8 lg:p-16">
            <div className={`max-w-xl w-full transition-all duration-500 ${
              isAnimating ? 'opacity-0 transform translate-y-4' : 'opacity-100 transform translate-y-0'
            }`}>
              {/* Header */}
              <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-white lg:text-gray-900 mb-6 leading-tight">
                {currentData.title}
              </h1>

              {/* Description */}
              <p className="text-lg lg:text-xl text-gray-200 lg:text-gray-600 mb-8 leading-relaxed">
